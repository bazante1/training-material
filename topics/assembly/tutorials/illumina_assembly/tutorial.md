...
title: Genome assembly using illumina data
zenodo_link: ''
questions:
...
>
> 1. **Convert compressed file to uncompressed.** {% icon tool %} with the following parameters:
>
...
## Sub-step with **staramr**

> ### {% icon hands_on %} Hands-on: Task description
>
> 1. **staramr** {% icon tool %} with the following parameters:
>    - In *"Advanced options"*:
>        - *"Exclude certain AMR genes from the results"*: `Exclude default list of AMR genes`
>
>    ***TODO***: *Check parameter descriptions*
>
>    ***TODO***: *Consider adding a comment or tip box*
...
>    - *"Use genus-specific BLAST database (--usegenus)"*: `Yes`
>    - *"Additional outputs"*: ``
>
>    ***TODO***: *Check parameter descriptions*
>
